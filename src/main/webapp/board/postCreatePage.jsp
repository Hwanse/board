				...
				<div class="row">
					<div class="col-sm-6 blog-main">
						...
						<form id="frm" class="form-horizontal" role="form"
							  action="${pageContext.request.contextPath }/postCreate"
							  method="post" enctype="multipart/form-data">

							<input type="hidden" name="boardseq" value="${board_seq }"/>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-5">
									<button id="postRegBtn" type="button" class="btn btn-default pull-right">게시글 등록</button>
								</div>
							</div>
